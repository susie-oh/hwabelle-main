...
export const WelcomeDiscountPopup: React.FC = () => {
  ...
  // Automated entrance timer & exit intent
  useEffect(() => {
  ...
  }, [location.pathname, isClaimed, isDismissed, isOpen, isExcludedRoute]);
    ...
    <>
      ...
      {!isExcludedRoute(location.pathname) && (
        <button
          ...
          className="fixed bottom-6 left-6 z-40 group flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-primary text-primary-foreground shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-primary/20 backdrop-blur"
          aria-label="Claim 10% Off Offer"
        >
          <Gift className="w-4 h-4 animate-pulse text-amber-300" />
      ...
      <Dialog open={isOpen} onOpenChange={(open) => !open && handleDismiss()}>
        <DialogContent className="max-w-md w-[92vw] p-0 overflow-hidden rounded-3xl border border-primary/20 bg-card shadow-2xl">
          ...
          <div className="relative h-2.5 bg-gradient-to-r from-amber-200 via-primary to-amber-300" />

          {!isSuccess ? (
            <div className="p-6 sm:p-8">
              <DialogHeader className="text-center space-y-2 mb-4">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 text-amber-700 dark:text-amber-400 text-xs font-semibold uppercase tracking-wider mx-auto">
                  <Sparkles className="w-3.5 h-3.5" />
                  Exclusive Welcome Value Offer
                </div>
                <DialogTitle className="font-serif text-2xl sm:text-3xl font-bold text-foreground tracking-tight leading-tight">
              ...
              {/* Value Bullet Points */}
              <div className="my-4 p-3.5 rounded-2xl bg-secondary/60 border border-border/60 space-y-2 text-left">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div className="pt-2 space-y-2">
                  <Button
                    ...
                    className="w-full h-11 rounded-xl bg-primary text-primary-foreground font-medium text-sm hover:bg-primary/90 transition-all shadow-md flex items-center justify-center gap-1.5"
                  >
            ...
            <div className="p-6 sm:p-8 text-center space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/30 border-2 border-dashed border-amber-300 dark:border-amber-700 text-center space-y-2">
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <Button
                    ...
                    className="h-8 px-2.5 text-xs rounded-lg gap-1 border-amber-300 bg-background hover:bg-amber-100 dark:hover:bg-amber-900"
                  >
                    {copied ? (
                      <>
              ...
              <div className="space-y-2 pt-1">
                <Button
                  ...
                  className="w-full text-sm font-semibold shadow-md flex items-center justify-center gap-2"
                >
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex-1 h-9 rounded-xl border border-border text-xs font-medium text-foreground hover:bg-secondary flex items-center justify-center gap-1.5 transition-colors"
                  >
                  ...
                  <Button
                    ...
                    className="flex-1 h-9 rounded-xl border border-border text-xs font-medium text-foreground hover:bg-secondary flex items-center justify-center gap-1.5"
                  >
